        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="adduser.php">
            <div class="form-group col-sm-6">
              ...
              <div class="col-sm-10">
                <input name="name" type="text" class="form-control" placeholder="李力" required />
              </div>
            </div>
              ...
              <div class="m-b-sm col-sm-6">
                <div class="btn-group" data-toggle="buttons">
                  <label class="btn btn-sm btn-info active">
                    <input name="sex" type="radio" > <i class="fa fa-check text-active"></i>
                    男
                  </label>
            ...
            <div class="form-group col-sm-6">
              ...
              <div class="col-sm-10">
                <input name="telphone" type="text" class="form-control" placeholder="18700001111"></div>
            </div>
            ...
            <div class="form-group col-sm-6">
              ...
              <div class="col-sm-10">
                <input name="QQnum" type="text" class="form-control" placeholder="1234567890"></div>
            </div>
            ...
            <div class="form-group col-sm-6">
              ...
              <div class="col-sm-10">
                <input name="email" type="text" class="form-control" placeholder="xxxxx@gmail.com"></div>
            </div>
            ...
            <div class="form-group col-sm-6">
              <div class="col-sm-offset-4">
                <button type="submit" class="btn btn-s-md btn-success">提交</button>
              </div>
            </div>
          </form>
        </div>
